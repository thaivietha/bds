...
$table_name = $db_config['prefix'] . '_' . $module_data . '_request';
...
if (! empty($array_search['q'])) {
    ...
    $where .= ' AND (address_area LIKE "%' . $array_search['q'] . '%"
        OR fullname LIKE "%' . $array_search['q'] . '%"
...
while ($view = $sth->fetch()) {
    ...
    $view['cat'] = ! empty($view['catid']) ? $array_bds_cat[$view['catid']]['title'] : '';
    $view['direction'] = ! empty($view['directionid']) ? $array_direction[$view['directionid']]['title'] : '';
	$view['legal'] = ! empty($view['legalid']) ? $array_legal[$view['legalid']]['title'] : '';
    $view['link_delete'] = NV_BASE_ADMINURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' . $module_name . '&amp;' . NV_OP_VARIABLE . '=' . $op . '&amp;delete_id=' . $view['id'] . '&amp;delete_checkss=' . md5($view['id'] . NV_CACHE_PREFIX . $client_info['session_id']);
    $view['link_view'] = NV_BASE_ADMINURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' . $module_name . '&amp;' . NV_OP_VARIABLE . '=request-detail&amp;id=' . $view['id'];
