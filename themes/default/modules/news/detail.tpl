...
<div class="news_column panel panel-default">
    <div class="panel-body other-news">
        ...
        <div class="clearfix">
            ...
            <div class="clearfix">
                <ul class="detail-related related list-none list-items">
                    <!-- BEGIN: loop -->
                    <li>
                        <em class="fa fa-angle-right">&nbsp;</em> <a href="{TOPIC.link}" {TOPIC.target_blank} <!-- BEGIN: tooltip -->data-placement="{TOOLTIP_POSITION}" data-content="{TOPIC.hometext_clean}" data-img="{TOPIC.imghome}" data-rel="tooltip"<!-- END: tooltip --> title="{TOPIC.title}">{TOPIC.title}</a> <em>({TOPIC.time})</em>
                    </li>
                    <!-- END: loop -->
                </ul>
            </div>
        ...
        <!-- BEGIN: related_new -->
        <p class="h3">{LANG.related_new}</p>
        <div class="clearfix">
            <ul class="detail-related related list-none list-items">
                <!-- BEGIN: loop -->
                <li>
                    <em class="fa fa-angle-right">&nbsp;</em> <a href="{RELATED_NEW.link}" {RELATED_NEW.target_blank} <!-- BEGIN: tooltip -->data-placement="{TOOLTIP_POSITION}" data-content="{RELATED_NEW.hometext_clean}" data-img="{RELATED_NEW.imghome}" data-rel="tooltip"<!-- END: tooltip --> title="{RELATED_NEW.title}">{RELATED_NEW.title}</a> <em>({RELATED_NEW.time})</em>
                </li>
                <!-- END: loop -->
            </ul>
        </div>
        ...
        <!-- BEGIN: related -->
        <p class="h3">{LANG.related}</p>
        <div class="clearfix">
            <ul class="detail-related related list-none list-items">
                <!-- BEGIN: loop -->
                <li>
                    <em class="fa fa-angle-right">&nbsp;</em> <a href="{RELATED.link}" {RELATED.target_blank} <!-- BEGIN: tooltip --> data-placement="{TOOLTIP_POSITION}" data-content="{RELATED.hometext_clean}" data-img="{RELATED.imghome}" data-rel="tooltip"<!-- END: tooltip --> title="{RELATED.title}">{RELATED.title}</a> <em>({RELATED.time})</em>
                </li>
                <!-- END: loop -->
            </ul>
        </div>
