...
<div class="row location-row">
	...
	<!-- BEGIN: province -->
	<div class="{CONFIG.col_class} province">
	...
	<!-- BEGIN: district -->
	<div class="{CONFIG.col_class} district">
		<select class="form-control location" data-type="districtid"
			...
			<!-- END: multiple --> >
			<!-- BEGIN: blank_title -->
			<option value="0">{LANG.district}</option>
			<!-- END: blank_title -->
			<!-- BEGIN: loop -->
	...
	<!-- BEGIN: ward -->
	<div class="{CONFIG.col_class} ward">
